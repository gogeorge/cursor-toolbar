...
#ifndef CURSOR_TOOLBAR_SWIFT_H
#define CURSOR_TOOLBAR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="cursor_toolbar",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14cursor_toolbar18ToolbarCoordinator")
@interface ToolbarCoordinator : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC14cursor_toolbar12ToolbarPanel")
@interface ToolbarPanel : NSPanel
/// Allows <code>TextEditor</code> / text fields to receive keyboard input while using a non-activating panel style.
